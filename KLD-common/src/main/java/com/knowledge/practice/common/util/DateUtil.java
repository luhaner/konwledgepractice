...
public class DateUtil {
     ...
     */
    public static final String DATE_FORMAT_YYYYMMDDHH = "yyyyMMddHHmm";
     ...
     * @return
     */
    public static String parseCurDateToStr(String timeFromat) {
        return parseDateToStr(getCurDate(), timeFromat);
    }
    ...
    /**
     * 身份证的时间20180525转换为2018-05-25
     * 
     * @param date
     * @return
     */
    public static String dateFormat(String date) {
        Date tempDate = parseStrToDate(date, DATE_FORMAT_YYYYMMDD);
        if (null == tempDate) {
            return null;
        }
        return parseDateToStr(tempDate, DATE_FORMAT_YYYY_MM_DD);
    }

    /**
     * 提交借款时间，20180525转换为2018/05/25
     *
     * @param date
     * @return
     */
    public static String loanDateFormat(String date) {
        Date tempDate = parseStrToDate(date, DATE_FORMAT_YYYYMMDD);
        if (null == tempDate) {
            return null;
        }
        return parseDateToStr(tempDate, DATE_FORMAT_SLASHYYYYMMDD);
    }

    /**
     * 工作开始时间，13444424441转换为2018/05/25
     * 
     * @param date
     * @return
     */
    public static String longDateFormat(String date) {
        ...
        return parseDateToStr(timeDate, DATE_FORMAT_SLASHYYYYMMDD);
    }
     ...
     * @return
     */
    public static Long getNextDayZero(Long currentTime) {
        return currentTime / (1000 * 3600 * 24) * (1000 * 3600 * 24) - TimeZone.getDefault().getRawOffset() + 24 * 3600 * 1000;
    }

    /**
     * 获取当天0时0分0前后天数0时0分0秒的时间戳
     * 
     * @param interval 间隔
     * @return
     */
    public static Long getCurrentTimeIgnoreHmsAddDays(Long interval) {
        long rowOffset = TimeZone.getDefault().getRawOffset();
        long current = System.currentTimeMillis();
        long currentIgnoreHms = (current + rowOffset) / (1000 * 3600 * 24) * (1000 * 3600 * 24) - rowOffset;
        return currentIgnoreHms - TimeUnit.DAYS.toMillis(interval.longValue());
    }
    
    /**
     *   
     * 将Long类型的时间格式转换指定格式的字符串时间格式
     * @param time
     * @param format
     * @return
     */
     public static String stringToDate(Long time,String format){
     ...
     * @return
     */
    public static Date getDateZeroOclock(Long time){
...
//        System.out.println(getCurrentTimeIgnoreHmsAddDays(2L));
//        System.out.println(getCurrentTimeIgnoreHmsAddDays(1L));
        System.out.println(stringToDate(1529783200000L,""));
    }
